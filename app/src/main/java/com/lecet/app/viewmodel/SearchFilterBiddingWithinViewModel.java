...
public class SearchFilterBiddingWithinViewModel extends BaseObservable {
    private AppCompatActivity activity;

    public static final String BUNDLE_KEY_DISPLAY_STR = "com.lecet.app.viewmodel.SearchFilterBiddingWithinViewModel.display.displayText.extra";
    public static final String BUNDLE_KEY_DAYS_INT    = "com.lecet.app.viewmodel.SearchFilterBiddingWithinViewModel.display.daysInt.extra";
     ...
     * Constructor
     */
    public SearchFilterBiddingWithinViewModel(AppCompatActivity activity) {
    ...
    public void onSelected(View view) {
        ...
        setBiddingWithinData(displayStr, daysInt);
    }

    public void setBiddingWithinData(String displayStr, String daysInt) {
